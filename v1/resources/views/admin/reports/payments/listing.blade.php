		...
		<section class="pt-0 pb-0">
            <div class="paddingleftright custom-tabs ">
                ...
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  ...
                  <a href="{{url('admin/account_report/today?filter='.$filter_type.'&value='.Crypt::encryptString($filter_value))}}" class="nav-item nav-link {{ (request()->segment(3) == 'today') ? 'active' : '' }}">Today's </a>
                  <a href="{{url('admin/account_report/recent?filter='.$filter_type.'&value='.Crypt::encryptString($filter_value))}}" class="nav-item nav-link {{ (request()->segment(3) == 'recent') ? 'active' : '' }}">Recent(30 days) </a>
                  <a href="{{url('admin/account_report/monthly?filter='.$filter_type.'&value='.Crypt::encryptString($filter_value))}}" class="nav-item nav-link {{ (request()->segment(3) == 'monthly') ? 'active' : '' }}">Monthly Export data</a>
				...
				@if(request()->is('admin/account_report/monthly'))
				...
				<form class="form-inline form_export" action="{{route('admin.report.export')}}">
                ...
                <br> <br>
				<table  class="table table-bordered payments-data-table" style="width:100%;font-size:13px;!important;">
                  <thead>
                      <tr>				
					    <th>Order ID</th>
                        <th>Grand Total</th>                       
