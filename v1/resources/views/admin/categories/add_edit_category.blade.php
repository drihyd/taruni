...
$attributes_data=DB::table('attributes')->orderBy('attr_name','ASC')->get();
@endphp
...
@endif  
      ...
      <button type="submit" class="btn btn-outline-success btn-sm mt-3">Save</button>
              <a href="{{url(\GetRolecode::_getRolecode(Auth::user()->role??'').'/categories')}}" class="btn btn-outline-danger btn-sm mt-3">Back</a>
    </div>
    <div class="col-md-5"> 
          <div class="form-group">
